...
namespace Lambdas {
    ...
    // freie Funktion  // free function
    static bool compare (int n1, int n2) {
        std::println("compare {} mit {}", n1, n2);
        return n1 > n2;
    }
    ...
    public:
        ...
        bool operator() (int n1, int n2, int n3) const {
            std::println("Comparer: {} mit {}", n1, n2);
    ...
    static void test_07() {
        ...
        auto lambda = [&flag, variable = 10, variable2 = 10] () mutable -> int {
