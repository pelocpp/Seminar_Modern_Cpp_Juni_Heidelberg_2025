...
namespace Auto_Examples {
    ...
    static void test_01() {
        ...
        int n;  // Type Deduction // Typableitung
        auto z = 123;
  ...
  //      int result2{ (int)d + n }; // NICHT: implizit
    }
    ...
    //static auto tueWasSeminar(bool flag, float f, double d) -> double
    //{
    //    if (flag)
    //        return d;
    //    else
    ...
    static auto tueWasSeminar(bool flag, T f, U d) -> decltype(f+d)
    {
    ...
    void test_seminar()
    {
        tueWasSeminar(false, 123, 123.456);
    }
